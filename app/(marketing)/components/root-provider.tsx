...
import { ComponentWithChildren } from "@thirdweb-dev/react/dist/declarations/src/core/types/component";
...
export const RootProvider: ComponentWithChildren = ({ children }) => {
  return (
    <>
      <Global
        styles={css`
