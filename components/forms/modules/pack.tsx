...
import { PackContractInput, PackContractSchema } from "schema/contracts";

interface IPackModuleForm extends IFormProps {
  onSubmit: (data: PackContractInput) => Promise<void>;
}

export const PackModuleForm: React.FC<IPackModuleForm> = ({
  formId,
  onSubmit,
}) => {
  ...
  const {
    ...
    resolver: zodResolver(PackContractSchema),
    defaultValues: {
