...
import { CompanySettingsOverview } from "./overview/company-settings-overview";
import { useTrack } from "hooks/analytics/useTrack";
import { EngineInstance } from "@3rdweb-sdk/react/hooks/useEngine";
import { FiArrowLeft } from "react-icons/fi";

interface CompanySettingsNavigationProps {
  instance: EngineInstance;
  setConnectedInstance: Dispatch<SetStateAction<EngineInstance | undefined>>;
}

export const CompanySettingsNavigation: React.FC<
  CompanySettingsNavigationProps
> = ({ instance, setConnectedInstance }) => {
  const tabs = [
    {
      title: "Overview",
      isDisabled: false,
      disabledText: "",
      children: <CompanySettingsOverview instance={instance.url} />,
    },
    {
      title: "Explorer",
      isDisabled: false,
