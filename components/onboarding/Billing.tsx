  ...
  return (
    <Flex flexDir="column" gap={8}>
      <OnboardingTitle
        ...
        description="thirdweb is free to get started with monthly usage limits. Add a payment method to ensure you experience no interruptions after exceeding limits."
      />
      <Flex flexDir="column" gap={8}>
        {stripePromise && (
          <Elements
