...
const steps = [
  {
    ...
    text: (
      <>
        Build contracts easily with <b>ContractKit</b>.
        <br />
        Skip ahead with <b>Prebuilt contracts</b> for common use cases.
        <br />
        Integrate any contract into your app with autogenerated <b>SDKs</b>.
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        Deploy contracts securely using <b>CLI</b> and <b>Dashboard</b>
        .
        <br />
        Scale apps easily without worrying about web3 infrastructure.
        <br />
        Create shareable landing pages for contracts with <b>Release</b>.
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        Monitor on-chain acitivity with <b>Analytics</b>.
        <br />
        Interact directly with contracts using <b>Dashboard</b>.
        <br />
        Control your team&apos;s access with <b>Permissions</b>.
      </>
    ),
