...
import { CollectionModule } from "@3rdweb/sdk";
import {
  Accordion,
  AccordionButton,
  AccordionIcon,
...
export const CollectionMintForm: React.FC<ICollectionMintForm> = ({
  ...
  const mint = useCollectionCreateAndMintMutation(module);
  const {
    setValue,
    control,
    register,
  ...
  const onSubmit = (data: CollectionTokenInput) => {
