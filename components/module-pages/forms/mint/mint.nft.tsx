...
import { NFTTokenInput, NftTokenSchema } from "schema/tokens";
...
export const NFTMintForm: React.FC<INFTMintForm> = ({ module }) => {
  const mint = useNftMintMutation(module);
  const {
    setValue,
    control,
    register,
  ...
  const onSubmit = (data: NFTTokenInput) => {
