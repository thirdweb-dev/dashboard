...
import { DropTokenInput, DropTokenSchema } from "schema/tokens";
...
export const BundleDropMintForm: React.FC<IDropMintForm> = ({ module }) => {
  const mint = useBundleDropMintMutation(module);
  const {
    setValue,
    control,
    register,
  ...
  const onSubmit = (data: DropTokenInput) => {
