  ...
  return (
    <Flex gap={8} direction="column">
      ...
      >
        ...
        {publishedContracts.isSuccess && publishedContracts.data.length === 0 && (
          <Center>
...
const ContractsHomepage: NextPageWithLayout = function () {
  return (
    <PublisherSDKContext>
...
ContractsHomepage.trackingScope = "contracts_home";
