...
const SettingsCompanySettingsPage: ThirdwebNextPage = () => {
...
SettingsCompanySettingsPage.getLayout = (page, props) => (
...
SettingsCompanySettingsPage.pageId = PageId.SettingsApiKeys;

export default SettingsCompanySettingsPage;
