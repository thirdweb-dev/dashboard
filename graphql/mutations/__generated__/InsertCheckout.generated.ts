 ...
 *
 * @example
 * const [insertCheckoutMutation, { data, loading, error }] = useInsertCheckoutMutation({
 *   variables: {
 *      checkout: // value for 'checkout'
 *   },
 * });
 */
export function useInsertCheckoutMutation(baseOptions?: Apollo.MutationHookOptions<InsertCheckoutMutation, InsertCheckoutMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<InsertCheckoutMutation, InsertCheckoutMutationVariables>(InsertCheckoutDocument, options);
      }
export type InsertCheckoutMutationHookResult = ReturnType<typeof useInsertCheckoutMutation>;
export type InsertCheckoutMutationResult = Apollo.MutationResult<InsertCheckoutMutation>;
export type InsertCheckoutMutationOptions = Apollo.BaseMutationOptions<InsertCheckoutMutation, InsertCheckoutMutationVariables>;