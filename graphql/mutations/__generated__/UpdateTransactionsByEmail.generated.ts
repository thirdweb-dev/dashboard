...
export type UpdateTransactionsByEmailMutationFn = Apollo.MutationFunction<UpdateTransactionsByEmailMutation, UpdateTransactionsByEmailMutationVariables>;

/**
 * __useUpdateTransactionsByEmailMutation__
 *
 * To run a mutation, you first call `useUpdateTransactionsByEmailMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateTransactionsByEmailMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateTransactionsByEmailMutation, { data, loading, error }] = useUpdateTransactionsByEmailMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateTransactionsByEmailMutation(baseOptions?: Apollo.MutationHookOptions<UpdateTransactionsByEmailMutation, UpdateTransactionsByEmailMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateTransactionsByEmailMutation, UpdateTransactionsByEmailMutationVariables>(UpdateTransactionsByEmailDocument, options);
      }
export type UpdateTransactionsByEmailMutationHookResult = ReturnType<typeof useUpdateTransactionsByEmailMutation>;
export type UpdateTransactionsByEmailMutationResult = Apollo.MutationResult<UpdateTransactionsByEmailMutation>;
export type UpdateTransactionsByEmailMutationOptions = Apollo.BaseMutationOptions<UpdateTransactionsByEmailMutation, UpdateTransactionsByEmailMutationVariables>;