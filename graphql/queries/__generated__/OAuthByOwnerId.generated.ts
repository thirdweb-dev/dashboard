 ...
 * });
 */
export function useOAuthByOwnerIdQuery(baseOptions: Apollo.QueryHookOptions<OAuthByOwnerIdQuery, OAuthByOwnerIdQueryVariables> & ({ variables: OAuthByOwnerIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
