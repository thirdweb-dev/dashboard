 ...
 * });
 */
export function useAnalyticOverviewQuery(baseOptions: Apollo.QueryHookOptions<AnalyticOverviewQuery, AnalyticOverviewQueryVariables> & ({ variables: AnalyticOverviewQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
