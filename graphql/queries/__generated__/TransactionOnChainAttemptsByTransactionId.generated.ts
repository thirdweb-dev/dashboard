...
/**
 * __useTransactionOnChainAttemptsByTransactionIdQuery__
 *
 * To run a query within a React component, call `useTransactionOnChainAttemptsByTransactionIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionOnChainAttemptsByTransactionIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionOnChainAttemptsByTransactionIdQuery({
 *   variables: {
 ...
 * });
 */
export function useTransactionOnChainAttemptsByTransactionIdQuery(baseOptions: Apollo.QueryHookOptions<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables> & ({ variables: TransactionOnChainAttemptsByTransactionIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables>(TransactionOnChainAttemptsByTransactionIdDocument, options);
      }
export function useTransactionOnChainAttemptsByTransactionIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables>(TransactionOnChainAttemptsByTransactionIdDocument, options);
        }
export function useTransactionOnChainAttemptsByTransactionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables>(TransactionOnChainAttemptsByTransactionIdDocument, options);
        }
export type TransactionOnChainAttemptsByTransactionIdQueryHookResult = ReturnType<typeof useTransactionOnChainAttemptsByTransactionIdQuery>;
export type TransactionOnChainAttemptsByTransactionIdLazyQueryHookResult = ReturnType<typeof useTransactionOnChainAttemptsByTransactionIdLazyQuery>;
export type TransactionOnChainAttemptsByTransactionIdSuspenseQueryHookResult = ReturnType<typeof useTransactionOnChainAttemptsByTransactionIdSuspenseQuery>;
export type TransactionOnChainAttemptsByTransactionIdQueryResult = Apollo.QueryResult<TransactionOnChainAttemptsByTransactionIdQuery, TransactionOnChainAttemptsByTransactionIdQueryVariables>;