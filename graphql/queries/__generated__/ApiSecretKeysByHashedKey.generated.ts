 ...
 * });
 */
export function useApiSecretKeyByHashedKeyQuery(baseOptions: Apollo.QueryHookOptions<ApiSecretKeyByHashedKeyQuery, ApiSecretKeyByHashedKeyQueryVariables> & ({ variables: ApiSecretKeyByHashedKeyQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
