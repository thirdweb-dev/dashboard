 ...
 * });
 */
export function useOAuthByClientIdQuery(baseOptions: Apollo.QueryHookOptions<OAuthByClientIdQuery, OAuthByClientIdQueryVariables> & ({ variables: OAuthByClientIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
