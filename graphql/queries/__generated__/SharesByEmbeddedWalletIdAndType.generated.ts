 ...
 * });
 */
export function useSharesByEmbeddedWalletIdAndTypeQuery(baseOptions: Apollo.QueryHookOptions<SharesByEmbeddedWalletIdAndTypeQuery, SharesByEmbeddedWalletIdAndTypeQueryVariables> & ({ variables: SharesByEmbeddedWalletIdAndTypeQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
