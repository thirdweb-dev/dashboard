 ...
 * });
 */
export function useFloatWalletQuery(baseOptions: Apollo.QueryHookOptions<FloatWalletQuery, FloatWalletQueryVariables> & ({ variables: FloatWalletQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
