...
/**
 * __useTransactionsBetweenDatesQuery__
 *
 * To run a query within a React component, call `useTransactionsBetweenDatesQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionsBetweenDatesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionsBetweenDatesQuery({
 *   variables: {
 *      sellerEmail: // value for 'sellerEmail'
 *      startDate: // value for 'startDate'
 *      endDate: // value for 'endDate'
 *   },
 * });
 */
export function useTransactionsBetweenDatesQuery(baseOptions: Apollo.QueryHookOptions<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables> & ({ variables: TransactionsBetweenDatesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables>(TransactionsBetweenDatesDocument, options);
      }
export function useTransactionsBetweenDatesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables>(TransactionsBetweenDatesDocument, options);
        }
export function useTransactionsBetweenDatesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables>(TransactionsBetweenDatesDocument, options);
        }
export type TransactionsBetweenDatesQueryHookResult = ReturnType<typeof useTransactionsBetweenDatesQuery>;
export type TransactionsBetweenDatesLazyQueryHookResult = ReturnType<typeof useTransactionsBetweenDatesLazyQuery>;
export type TransactionsBetweenDatesSuspenseQueryHookResult = ReturnType<typeof useTransactionsBetweenDatesSuspenseQuery>;
export type TransactionsBetweenDatesQueryResult = Apollo.QueryResult<TransactionsBetweenDatesQuery, TransactionsBetweenDatesQueryVariables>;