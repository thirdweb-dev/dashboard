 ...
 * });
 */
export function useEmbeddedWalletByAddressQuery(baseOptions: Apollo.QueryHookOptions<EmbeddedWalletByAddressQuery, EmbeddedWalletByAddressQueryVariables> & ({ variables: EmbeddedWalletByAddressQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
