 ...
 * });
 */
export function useCustomerByEmailQuery(baseOptions: Apollo.QueryHookOptions<CustomerByEmailQuery, CustomerByEmailQueryVariables> & ({ variables: CustomerByEmailQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
