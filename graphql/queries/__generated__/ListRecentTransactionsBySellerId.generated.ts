...
/**
 * __useListRecentTransactionsBySellerIdQuery__
 *
 * To run a query within a React component, call `useListRecentTransactionsBySellerIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useListRecentTransactionsBySellerIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useListRecentTransactionsBySellerIdQuery({
 *   variables: {
 ...
 * });
 */
export function useListRecentTransactionsBySellerIdQuery(baseOptions: Apollo.QueryHookOptions<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables> & ({ variables: ListRecentTransactionsBySellerIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables>(ListRecentTransactionsBySellerIdDocument, options);
      }
export function useListRecentTransactionsBySellerIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables>(ListRecentTransactionsBySellerIdDocument, options);
        }
export function useListRecentTransactionsBySellerIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables>(ListRecentTransactionsBySellerIdDocument, options);
        }
export type ListRecentTransactionsBySellerIdQueryHookResult = ReturnType<typeof useListRecentTransactionsBySellerIdQuery>;
export type ListRecentTransactionsBySellerIdLazyQueryHookResult = ReturnType<typeof useListRecentTransactionsBySellerIdLazyQuery>;
export type ListRecentTransactionsBySellerIdSuspenseQueryHookResult = ReturnType<typeof useListRecentTransactionsBySellerIdSuspenseQuery>;
export type ListRecentTransactionsBySellerIdQueryResult = Apollo.QueryResult<ListRecentTransactionsBySellerIdQuery, ListRecentTransactionsBySellerIdQueryVariables>;