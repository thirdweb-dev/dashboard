 ...
 * });
 */
export function useSellerPrivateQuery(baseOptions: Apollo.QueryHookOptions<SellerPrivateQuery, SellerPrivateQueryVariables> & ({ variables: SellerPrivateQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
