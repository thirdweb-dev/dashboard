 ...
 * });
 */
export function useAccountInviteQuery(baseOptions: Apollo.QueryHookOptions<AccountInviteQuery, AccountInviteQueryVariables> & ({ variables: AccountInviteQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
