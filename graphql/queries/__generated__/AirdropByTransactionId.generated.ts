 ...
 * });
 */
export function useAirdropByTransactionIdQuery(baseOptions: Apollo.QueryHookOptions<AirdropByTransactionIdQuery, AirdropByTransactionIdQueryVariables> & ({ variables: AirdropByTransactionIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
