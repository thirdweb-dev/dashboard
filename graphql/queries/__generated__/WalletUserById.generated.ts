 ...
 * });
 */
export function useWalletUserByIdQuery(baseOptions: Apollo.QueryHookOptions<WalletUserByIdQuery, WalletUserByIdQueryVariables> & ({ variables: WalletUserByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
