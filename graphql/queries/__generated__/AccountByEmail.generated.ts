 ...
 * });
 */
export function useAccountByEmailQuery(baseOptions: Apollo.QueryHookOptions<AccountByEmailQuery, AccountByEmailQueryVariables> & ({ variables: AccountByEmailQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
