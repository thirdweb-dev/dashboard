 ...
 * });
 */
export function useListSellersByStripeCustomerIdQuery(baseOptions: Apollo.QueryHookOptions<ListSellersByStripeCustomerIdQuery, ListSellersByStripeCustomerIdQueryVariables> & ({ variables: ListSellersByStripeCustomerIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
