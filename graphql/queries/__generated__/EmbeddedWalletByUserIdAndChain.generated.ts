 ...
 * });
 */
export function useEmbeddedWalletByUserIdAndChainQuery(baseOptions: Apollo.QueryHookOptions<EmbeddedWalletByUserIdAndChainQuery, EmbeddedWalletByUserIdAndChainQueryVariables> & ({ variables: EmbeddedWalletByUserIdAndChainQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
