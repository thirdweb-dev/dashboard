 ...
 * });
 */
export function useFiatPayoutBySellerQuery(baseOptions: Apollo.QueryHookOptions<FiatPayoutBySellerQuery, FiatPayoutBySellerQueryVariables> & ({ variables: FiatPayoutBySellerQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
