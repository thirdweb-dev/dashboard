...
/**
 * __useRecentCompleteTransactionsQuery__
 *
 * To run a query within a React component, call `useRecentCompleteTransactionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useRecentCompleteTransactionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRecentCompleteTransactionsQuery({
 *   variables: {
 *      sellerCreatedAt: // value for 'sellerCreatedAt'
 *   },
 * });
 */
export function useRecentCompleteTransactionsQuery(baseOptions: Apollo.QueryHookOptions<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables> & ({ variables: RecentCompleteTransactionsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables>(RecentCompleteTransactionsDocument, options);
      }
export function useRecentCompleteTransactionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables>(RecentCompleteTransactionsDocument, options);
        }
export function useRecentCompleteTransactionsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables>(RecentCompleteTransactionsDocument, options);
        }
export type RecentCompleteTransactionsQueryHookResult = ReturnType<typeof useRecentCompleteTransactionsQuery>;
export type RecentCompleteTransactionsLazyQueryHookResult = ReturnType<typeof useRecentCompleteTransactionsLazyQuery>;
export type RecentCompleteTransactionsSuspenseQueryHookResult = ReturnType<typeof useRecentCompleteTransactionsSuspenseQuery>;
export type RecentCompleteTransactionsQueryResult = Apollo.QueryResult<RecentCompleteTransactionsQuery, RecentCompleteTransactionsQueryVariables>;