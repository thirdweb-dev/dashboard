 ...
 * });
 */
export function useSellerByEmailQuery(baseOptions: Apollo.QueryHookOptions<SellerByEmailQuery, SellerByEmailQueryVariables> & ({ variables: SellerByEmailQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
