...
export type TransactionByTransactionHashQueryVariables = Types.Exact<{
...
export const TransactionByTransactionHashDocument = gql`
    query TransactionByTransactionHash($transactionHash: String!) {
  transaction(where: {transaction_hash: {_eq: $transactionHash}}) {
    ...Transaction
  }
}
...
/**
 * __useTransactionByTransactionHashQuery__
 *
 * To run a query within a React component, call `useTransactionByTransactionHashQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionByTransactionHashQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionByTransactionHashQuery({
 *   variables: {
 *      transactionHash: // value for 'transactionHash'
 *   },
 * });
 */
export function useTransactionByTransactionHashQuery(baseOptions: Apollo.QueryHookOptions<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables> & ({ variables: TransactionByTransactionHashQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables>(TransactionByTransactionHashDocument, options);
      }
export function useTransactionByTransactionHashLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables>(TransactionByTransactionHashDocument, options);
        }
export function useTransactionByTransactionHashSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables>(TransactionByTransactionHashDocument, options);
        }
export type TransactionByTransactionHashQueryHookResult = ReturnType<typeof useTransactionByTransactionHashQuery>;
export type TransactionByTransactionHashLazyQueryHookResult = ReturnType<typeof useTransactionByTransactionHashLazyQuery>;
export type TransactionByTransactionHashSuspenseQueryHookResult = ReturnType<typeof useTransactionByTransactionHashSuspenseQuery>;
export type TransactionByTransactionHashQueryResult = Apollo.QueryResult<TransactionByTransactionHashQuery, TransactionByTransactionHashQueryVariables>;