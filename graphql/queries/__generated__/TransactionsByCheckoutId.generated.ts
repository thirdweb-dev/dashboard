...
/**
 * __useTransactionsByCheckoutIdQuery__
 *
 * To run a query within a React component, call `useTransactionsByCheckoutIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionsByCheckoutIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionsByCheckoutIdQuery({
 *   variables: {
 *      checkoutId: // value for 'checkoutId'
 *   },
 * });
 */
export function useTransactionsByCheckoutIdQuery(baseOptions: Apollo.QueryHookOptions<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables> & ({ variables: TransactionsByCheckoutIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables>(TransactionsByCheckoutIdDocument, options);
      }
export function useTransactionsByCheckoutIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables>(TransactionsByCheckoutIdDocument, options);
        }
export function useTransactionsByCheckoutIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables>(TransactionsByCheckoutIdDocument, options);
        }
export type TransactionsByCheckoutIdQueryHookResult = ReturnType<typeof useTransactionsByCheckoutIdQuery>;
export type TransactionsByCheckoutIdLazyQueryHookResult = ReturnType<typeof useTransactionsByCheckoutIdLazyQuery>;
export type TransactionsByCheckoutIdSuspenseQueryHookResult = ReturnType<typeof useTransactionsByCheckoutIdSuspenseQuery>;
export type TransactionsByCheckoutIdQueryResult = Apollo.QueryResult<TransactionsByCheckoutIdQuery, TransactionsByCheckoutIdQueryVariables>;