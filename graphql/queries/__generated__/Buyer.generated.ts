 ...
 * });
 */
export function useBuyerQuery(baseOptions: Apollo.QueryHookOptions<BuyerQuery, BuyerQueryVariables> & ({ variables: BuyerQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
