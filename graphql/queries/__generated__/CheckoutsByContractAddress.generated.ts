 ...
 * });
 */
export function useCheckoutsByContractAddressQuery(baseOptions: Apollo.QueryHookOptions<CheckoutsByContractAddressQuery, CheckoutsByContractAddressQueryVariables>) {
