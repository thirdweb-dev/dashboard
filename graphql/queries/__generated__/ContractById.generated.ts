 ...
 * });
 */
export function useContractByIdQuery(baseOptions: Apollo.QueryHookOptions<ContractByIdQuery, ContractByIdQueryVariables> & ({ variables: ContractByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
