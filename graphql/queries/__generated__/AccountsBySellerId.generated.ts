 ...
 * });
 */
export function useAccountsBySellerIdQuery(baseOptions: Apollo.QueryHookOptions<AccountsBySellerIdQuery, AccountsBySellerIdQueryVariables> & ({ variables: AccountsBySellerIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
