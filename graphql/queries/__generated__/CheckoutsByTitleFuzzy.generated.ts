 ...
 * });
 */
export function useCheckoutsByTitleFuzzyQuery(baseOptions: Apollo.QueryHookOptions<CheckoutsByTitleFuzzyQuery, CheckoutsByTitleFuzzyQueryVariables> & ({ variables: CheckoutsByTitleFuzzyQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
