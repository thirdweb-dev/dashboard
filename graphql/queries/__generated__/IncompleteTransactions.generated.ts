...
/**
 * __useIncompleteTransactionsQuery__
 *
 * To run a query within a React component, call `useIncompleteTransactionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useIncompleteTransactionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIncompleteTransactionsQuery({
 *   variables: {
 *      startDate: // value for 'startDate'
 *   },
 * });
 */
export function useIncompleteTransactionsQuery(baseOptions: Apollo.QueryHookOptions<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables> & ({ variables: IncompleteTransactionsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables>(IncompleteTransactionsDocument, options);
      }
export function useIncompleteTransactionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables>(IncompleteTransactionsDocument, options);
        }
export function useIncompleteTransactionsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables>(IncompleteTransactionsDocument, options);
        }
export type IncompleteTransactionsQueryHookResult = ReturnType<typeof useIncompleteTransactionsQuery>;
export type IncompleteTransactionsLazyQueryHookResult = ReturnType<typeof useIncompleteTransactionsLazyQuery>;
export type IncompleteTransactionsSuspenseQueryHookResult = ReturnType<typeof useIncompleteTransactionsSuspenseQuery>;
export type IncompleteTransactionsQueryResult = Apollo.QueryResult<IncompleteTransactionsQuery, IncompleteTransactionsQueryVariables>;