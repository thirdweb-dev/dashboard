 ...
 * });
 */
export function useAirdropBySellerIdQuery(baseOptions: Apollo.QueryHookOptions<AirdropBySellerIdQuery, AirdropBySellerIdQueryVariables> & ({ variables: AirdropBySellerIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
