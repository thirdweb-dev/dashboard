...
/**
 * __useTransactionByQueueIdQuery__
 *
 * To run a query within a React component, call `useTransactionByQueueIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionByQueueIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionByQueueIdQuery({
 *   variables: {
 *      queueId: // value for 'queueId'
 *   },
 * });
 */
export function useTransactionByQueueIdQuery(baseOptions: Apollo.QueryHookOptions<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables> & ({ variables: TransactionByQueueIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables>(TransactionByQueueIdDocument, options);
      }
export function useTransactionByQueueIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables>(TransactionByQueueIdDocument, options);
        }
export function useTransactionByQueueIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables>(TransactionByQueueIdDocument, options);
        }
export type TransactionByQueueIdQueryHookResult = ReturnType<typeof useTransactionByQueueIdQuery>;
export type TransactionByQueueIdLazyQueryHookResult = ReturnType<typeof useTransactionByQueueIdLazyQuery>;
export type TransactionByQueueIdSuspenseQueryHookResult = ReturnType<typeof useTransactionByQueueIdSuspenseQuery>;
export type TransactionByQueueIdQueryResult = Apollo.QueryResult<TransactionByQueueIdQuery, TransactionByQueueIdQueryVariables>;