 ...
 * });
 */
export function useApiSecretKeysByPlaintextQuery(baseOptions: Apollo.QueryHookOptions<ApiSecretKeysByPlaintextQuery, ApiSecretKeysByPlaintextQueryVariables> & ({ variables: ApiSecretKeysByPlaintextQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
