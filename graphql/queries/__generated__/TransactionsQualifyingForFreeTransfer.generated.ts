...
/**
 * __useTransactionsQualifyingForFreeTransferQuery__
 *
 * To run a query within a React component, call `useTransactionsQualifyingForFreeTransferQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionsQualifyingForFreeTransferQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionsQualifyingForFreeTransferQuery({
 *   variables: {
 *      walletAddress: // value for 'walletAddress'
 *   },
 * });
 */
export function useTransactionsQualifyingForFreeTransferQuery(baseOptions: Apollo.QueryHookOptions<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables> & ({ variables: TransactionsQualifyingForFreeTransferQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables>(TransactionsQualifyingForFreeTransferDocument, options);
      }
export function useTransactionsQualifyingForFreeTransferLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables>(TransactionsQualifyingForFreeTransferDocument, options);
        }
export function useTransactionsQualifyingForFreeTransferSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables>(TransactionsQualifyingForFreeTransferDocument, options);
        }
export type TransactionsQualifyingForFreeTransferQueryHookResult = ReturnType<typeof useTransactionsQualifyingForFreeTransferQuery>;
export type TransactionsQualifyingForFreeTransferLazyQueryHookResult = ReturnType<typeof useTransactionsQualifyingForFreeTransferLazyQuery>;
export type TransactionsQualifyingForFreeTransferSuspenseQueryHookResult = ReturnType<typeof useTransactionsQualifyingForFreeTransferSuspenseQuery>;
export type TransactionsQualifyingForFreeTransferQueryResult = Apollo.QueryResult<TransactionsQualifyingForFreeTransferQuery, TransactionsQualifyingForFreeTransferQueryVariables>;