...
/**
 * __useListRecentTransactionsQuery__
 *
 * To run a query within a React component, call `useListRecentTransactionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useListRecentTransactionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useListRecentTransactionsQuery({
 *   variables: {
 ...
 * });
 */
export function useListRecentTransactionsQuery(baseOptions: Apollo.QueryHookOptions<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables> & ({ variables: ListRecentTransactionsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables>(ListRecentTransactionsDocument, options);
      }
export function useListRecentTransactionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables>(ListRecentTransactionsDocument, options);
        }
export function useListRecentTransactionsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables>(ListRecentTransactionsDocument, options);
        }
export type ListRecentTransactionsQueryHookResult = ReturnType<typeof useListRecentTransactionsQuery>;
export type ListRecentTransactionsLazyQueryHookResult = ReturnType<typeof useListRecentTransactionsLazyQuery>;
export type ListRecentTransactionsSuspenseQueryHookResult = ReturnType<typeof useListRecentTransactionsSuspenseQuery>;
export type ListRecentTransactionsQueryResult = Apollo.QueryResult<ListRecentTransactionsQuery, ListRecentTransactionsQueryVariables>;