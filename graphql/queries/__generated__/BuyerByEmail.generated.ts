 ...
 * });
 */
export function useBuyerByEmailQuery(baseOptions: Apollo.QueryHookOptions<BuyerByEmailQuery, BuyerByEmailQueryVariables> & ({ variables: BuyerByEmailQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
