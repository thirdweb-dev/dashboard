...
/**
 * __useUnclaimedTransactionsBySellersQuery__
 *
 * To run a query within a React component, call `useUnclaimedTransactionsBySellersQuery` and pass it any options that fit your needs.
 * When your component renders, `useUnclaimedTransactionsBySellersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUnclaimedTransactionsBySellersQuery({
 *   variables: {
 ...
 * });
 */
export function useUnclaimedTransactionsBySellersQuery(baseOptions: Apollo.QueryHookOptions<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables> & ({ variables: UnclaimedTransactionsBySellersQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables>(UnclaimedTransactionsBySellersDocument, options);
      }
export function useUnclaimedTransactionsBySellersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables>(UnclaimedTransactionsBySellersDocument, options);
        }
export function useUnclaimedTransactionsBySellersSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables>(UnclaimedTransactionsBySellersDocument, options);
        }
export type UnclaimedTransactionsBySellersQueryHookResult = ReturnType<typeof useUnclaimedTransactionsBySellersQuery>;
export type UnclaimedTransactionsBySellersLazyQueryHookResult = ReturnType<typeof useUnclaimedTransactionsBySellersLazyQuery>;
export type UnclaimedTransactionsBySellersSuspenseQueryHookResult = ReturnType<typeof useUnclaimedTransactionsBySellersSuspenseQuery>;
export type UnclaimedTransactionsBySellersQueryResult = Apollo.QueryResult<UnclaimedTransactionsBySellersQuery, UnclaimedTransactionsBySellersQueryVariables>;