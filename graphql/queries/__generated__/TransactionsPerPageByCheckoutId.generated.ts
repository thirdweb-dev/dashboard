...
export type TransactionsPerPageByCheckoutIdQueryVariables = Types.Exact<{
...
/**
 * __useTransactionsPerPageByCheckoutIdQuery__
 *
 * To run a query within a React component, call `useTransactionsPerPageByCheckoutIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useTransactionsPerPageByCheckoutIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTransactionsPerPageByCheckoutIdQuery({
 *   variables: {
 ...
 * });
 */
export function useTransactionsPerPageByCheckoutIdQuery(baseOptions: Apollo.QueryHookOptions<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables> & ({ variables: TransactionsPerPageByCheckoutIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables>(TransactionsPerPageByCheckoutIdDocument, options);
      }
export function useTransactionsPerPageByCheckoutIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables>(TransactionsPerPageByCheckoutIdDocument, options);
        }
export function useTransactionsPerPageByCheckoutIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables>(TransactionsPerPageByCheckoutIdDocument, options);
        }
export type TransactionsPerPageByCheckoutIdQueryHookResult = ReturnType<typeof useTransactionsPerPageByCheckoutIdQuery>;
export type TransactionsPerPageByCheckoutIdLazyQueryHookResult = ReturnType<typeof useTransactionsPerPageByCheckoutIdLazyQuery>;
export type TransactionsPerPageByCheckoutIdSuspenseQueryHookResult = ReturnType<typeof useTransactionsPerPageByCheckoutIdSuspenseQuery>;
export type TransactionsPerPageByCheckoutIdQueryResult = Apollo.QueryResult<TransactionsPerPageByCheckoutIdQuery, TransactionsPerPageByCheckoutIdQueryVariables>;