 ...
 * });
 */
export function useOAuthQuery(baseOptions: Apollo.QueryHookOptions<OAuthQuery, OAuthQueryVariables> & ({ variables: OAuthQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
